<?
define('C_REST_CLIENT_ID','local.66260264149786.40799145');//Application ID
define('C_REST_CLIENT_SECRET','eYlSoAnwmb4xKfoFj7vSZjHeFOl4bLWoaKGfHpmKSULygbrOY1');//Application key
// or
